...
<div class="max-w-md w-full">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden text-center">
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 px-6 py-12">
            ...
            <h1 class="text-3xl font-bold text-white">Payment Cancelled</h1>
        </div>
        ...
        <div class="px-6 py-8">
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                <p class="text-gray-600">You can try again later or contact us for assistance.</p>
            </div>
